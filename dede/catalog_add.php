...
else if($dopost=='savequick')
{
    ...
    $queryTemplate = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,engtype,typedir,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('~reid~','~topid~','~rank~','~typename~','~engtype~','~typedir~','$isdefault','$defaultname','$issend','$channeltype',
...
else if($dopost=='save')
{
    ...
    $in_query = "INSERT INTO `#@__arctype`(reid,topid,sortrank,typename,engtype,typedir,isdefault,defaultname,issend,channeltype,
    ...
    VALUES('$reid','$topid','$sortrank','$typename','$engtype','$typedir','$isdefault','$defaultname','$issend','$channeltype',
